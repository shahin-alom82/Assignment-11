                        ...
                        <form onSubmit={handleRegister} className="card-body ">
                            ...
                            <div className="form-control">
                                ...
                                <div>
                                    ...
                                    <button onClick={handleGoogleLogin} className="btn btn-outline justify-between rounded-b mt-4 w-full">
                                ...
                                <div className='flex items-center gap-2'>
                                    <label className="label">
                                        ...
                                        <p className='text-xs mt-5 ml-2'>Accept Your Terms Condition?</p>
                                    </label>
                                </div>
                            </div>
